...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel" data-interval="3000">
  <div class="carousel-inner">
    <?php 
      $active = true; // Đặt slide đầu tiên là active
  ...
  <div class="row">
    <div class="col">
      <div class="image-container">
        <img src="images/pngtree-sports-motion-silhouette-sports-poster-image_14841.jpg" class="img-fluid" alt="Responsive Image">
      </div>
    </div>
  </div>
</div>

<h1 style="text-align: center;color: red;">BỘ SƯU TẬP MỚI</h1>
<?php
        if(isset($_GET['trang'])){
            $page = $_GET['trang'];
        }else {
       ...
       ORDER BY id_sanpham DESC LIMIT $begin,2";
